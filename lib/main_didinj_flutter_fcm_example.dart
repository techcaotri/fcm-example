...
// and adjust it to the latest FCM firebase_messaging 11.2.5
...
Item _itemForMessage(Map<String, dynamic> message) {
  final dynamic data = jsonDecode(message['data'] ?? message);
...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  print("onBackgroundMessage: Handling a background message: $message");
...
void main() async {
  ...
  Firebase.initializeApp().whenComplete(() {
    ...
    runApp(
      MaterialApp(
        home: MyHomePage(title: 'Flutter FCM Scoreboard'),
      ),
    );
  });
}
